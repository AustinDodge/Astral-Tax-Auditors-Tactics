...
maxgrounddist = 5//the maximum distance from the ground tile
minceildist = 4//the minimum distance from the "ceiling", the height of the bigwall.
...
pitchance = 5//the chance that a wall over a pit will be eligible
        ...
        if ds_list_size(ylist) > 0{
            ...
            switch southorwest{
                case 0://south facing wall
                    ...
                    tile_add(industrialbg1,bigwallw*7,bigwallh*5,bigwallw,bigwallh,dx,dy,vtile.depth+3)
                    ; break;
                case 1://west facing wall
                    ...
                    dy -= 3
                    //dy += irandom_range(-3,3)
                    tile_add(industrialbg1,bigwallw*6,bigwallh*5,bigwallw,bigwallh,dx,dy,vtile.depth+3)
                    ; break;
                }
