/// @description sUnitResetUsedAbilities()
/*This script is called by a unit at the start of the turn to reset and single-turn
active abilities to unused. */




ds_list_replace(abilitiesusedlist,35,0)//35 sure footing
ds_list_replace(abilitiesusedlist,36,0)//36 nimble
ds_list_replace(abilitiesusedlist,37,0)//37 sprint

ds_list_replace(abilitiesusedlist,41,0)//41 leap
ds_list_replace(abilitiesusedlist,42,0)//42 first aid 1
ds_list_replace(abilitiesusedlist,43,0)//43 first aid 2
ds_list_replace(abilitiesusedlist,44,0)//44 first aid 3

ds_list_replace(abilitiesusedlist,46,0)//46 diversion
ds_list_replace(abilitiesusedlist,47,0)//47 blend in
ds_list_replace(abilitiesusedlist,48,0)//48 charmer

ds_list_replace(abilitiesusedlist,53,0)//53 reflexes
ds_list_replace(abilitiesusedlist,54,0)//54 adrenaline
