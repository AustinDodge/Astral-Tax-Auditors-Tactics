...
pitchance = 15//the chance that a wall over a pit will be eligible
        ...
        if ds_list_size(ylist) > 0{
            ...
            switch southorwest{
                case 0://south facing wall
                    ...
                    tile_add(parkbg1,bigwallw*7,bigwallh*irandom_range(0,1),bigwallw,tilewallh*2,dx,dy,vtile.depth+3)
                    ; break;
                case 1://west facing wall
                    ...
                    dy -= 3
                    //dy += irandom_range(-3,3)
                    tile_add(parkbg1,bigwallw*6,bigwallh*irandom_range(0,1),bigwallw,tilewallh*2,dx,dy,vtile.depth+3)
                    ; break;
                }
