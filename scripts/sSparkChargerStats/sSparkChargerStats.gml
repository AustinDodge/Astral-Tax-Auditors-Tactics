/// @description sSparkChargerStats()
/*this script sets the stats for the Electrobar weapon to the unit calling it.
*/
attackrange = 1//how far our the weapon can attack
attackminrange = 0//the minimum range from the unit
attackuprange = 3//the number of tiles up or down the weapon can attack, -1 for infinite
...
chainattacks = 3//if the weapon will chain attacks together, dealing damage to all units adjacent to the unit being attacked
...
weaponstrikesound = soundTazerDischarge1
weaponwindupsound = soundTazerCharge1
