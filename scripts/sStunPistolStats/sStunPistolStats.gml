...
chainattacks = 1//if the weapon will chain attacks together, dealing damage to all units adjacent to the unit being attacked
//the value indicates how far the attacks will chain
weaponhealing = 0//if the unit's current weapon is healing or hurting.

weapontraveltime = 4//how long the projectile, if any, takes to travel across a single tile.

weaponstrikesound = soundTazerDischarge2
weaponwindupsound = soundPlasmaCharge1
