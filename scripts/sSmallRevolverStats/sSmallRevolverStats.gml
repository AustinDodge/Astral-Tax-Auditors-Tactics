/// @description sSmallRevolverStats()
...
weapontraveltime = 2//how long the projectile, if any, takes to travel across a single tile.

weaponstrikesound = soundSpookyShot1
