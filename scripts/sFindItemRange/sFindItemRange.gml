...
if ds_list_find_value(vunit.abilitieslist,56) = 0{
    //regular throw distance is half strength
    //moves = ceil(vunit.strength/2)//how far a unit can throw is, for now, tied to strength
    moves = vunit.strength
    }else{
    //Throwing arm ability allows throwing items twice as far
    moves = vunit.strength + ceil(vunit.strength*2)
    }
    
//moves = vunit.strength//debug force
