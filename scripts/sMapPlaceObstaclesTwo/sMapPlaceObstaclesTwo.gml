...
ctile,j,vobstacle,vpos,velev,didtwo,southorwest,i,nolist;
frequency = argument0
howmany = 0
vrand = 0
...
if frequency > 0{//if there should be any tiles at all
    ...
    with oMapTile{
        ...
        if totalneighbors != 2{//if there are exactly two neighbors, that tile is essential and cannot have an object on it
                        ...
                        if allpath = 0{
                            ...
                            if vrand < frequency{//half as likely since tables are so big
                                for(j = 0; j < ds_list_size(templist); j += 1){
                                    ...
                                    switch maptheme{
                                        case 0: switch southorwest{
                                            case 0: vobstacle.sprite_index = sprshelves1south; break;
                                            case 1: vobstacle.sprite_index = sprshelves1west; break;
                                            }
                                            ; break;
                                        case 1: switch southorwest{
                                            case 0: vobstacle.sprite_index = sprlonghedgesouth; break;
                                            case 1: vobstacle.sprite_index = sprlonghedgewest; break;
                                            }
                                            ; break;
                                        }
                                    vobstacle.image_index = j
                                    vobstacle.obstacleheight = 2
