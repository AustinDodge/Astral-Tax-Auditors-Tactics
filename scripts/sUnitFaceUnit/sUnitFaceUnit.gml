/// @description sUnitFaceUnit(facer,facewho)
/// @param facer
/// @param facewho
/*This script returns the direction one unit, facer, should face so that it is facing another unit,
facewho.
*/
...
//whichface = 0
whichface = facer.facing//unit's current facing by default
...
if facer.mx = facewho.mx and facer.my = facewho.my{
    switch facer.facing{
