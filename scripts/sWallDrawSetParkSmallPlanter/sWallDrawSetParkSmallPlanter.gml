...
vheight = 2//the minimum required height(in cells)
vwidth = 1//the minimum required width(in cells)
mingrounddist = 1//the minimum distance from the ground tile
        ...
        if ds_list_size(ylist) > 0{
            ...
            switch southorwest{
                case 0://south facing wall
                    ...
                    tile_add(parkbg1,bigwallw*7,bigwallh*4,bigwallw,tilewallh*2,dx,dy,vtile.depth+3)
                    ; break;
                case 1://west facing wall
                    ...
                    dy -= 3
                    //dy += irandom_range(-3,3)
                    tile_add(parkbg1,bigwallw*6,bigwallh*4,bigwallw,tilewallh*2,dx,dy,vtile.depth+3)
                    ; break;
                }
