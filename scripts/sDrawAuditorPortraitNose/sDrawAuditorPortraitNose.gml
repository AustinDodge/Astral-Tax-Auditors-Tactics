/// @description sDrawAuditorPortraitNose(mypalette,pindex,vx,vy,flipped?)
/// @param mypalette
/// @param pindex
/// @param vx
/// @param vy
...
draw_sprite_ext(sAuditorPortraitPartsNose,portraitnoseindex,vx,vy,vscale,1,0,c_white,1)
