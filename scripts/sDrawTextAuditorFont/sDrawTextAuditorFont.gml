/// @description sDrawTextAuditorFont(x,y,outlinecolor,maincolor,string)
/// @param x
/// @param y
/// @param outlinecolor
/// @param maincolor
/// @param string
/*This script draws text in the auditor font with the specified colors. Returns the width
of the drawn text.
*/
