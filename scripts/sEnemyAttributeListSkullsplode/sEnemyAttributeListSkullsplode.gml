...
ds_list_replace(vlist,26,1)//26 strength
ds_list_replace(vlist,27,0)//27 skill
ds_list_replace(vlist,28,0)//28 accuracy
ds_list_replace(vlist,30,10)//30 maxhp
ds_list_replace(vlist,29,10)//29 hp
ds_list_replace(vlist,31,2)//31 defense
...
ds_list_add(vlist,4)//24 moverange
ds_list_replace(vlist,45,9)//45 vision range
ds_list_replace(vlist,25,2)//25 uprange

ds_list_replace(vlist,35,4)//35 unittype, skullsplode
