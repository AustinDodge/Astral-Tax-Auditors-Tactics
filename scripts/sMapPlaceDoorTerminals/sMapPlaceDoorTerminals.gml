/// @description sMapPlaceDoorTerminals(howmany)
/// @param howmany
/*This script places door terminals on the map. It determines the best place for the tile by 
*/
var frequency,vtile,vterminal,vlist,howmany,i,vprio,vval,valuelist,j,ctile,vx,vy,k,velev,nlist,tileloops,vtype;
howmany = argument0
tileloops = 0
while howmany > 0{//if there should be any tiles at all
    if tileloops > 20{
        show_message("Have tried "+string(tileloops)+" times to make terminals, but nothing seems to work!")
    ...
    if ds_list_size(vlist) > 0{//if there are any eligible tiles
        ...
        if nosolution = 0{//if there is a valid tile
            ...
            ds_grid_set(tiletypegrid,vtile.mx,vtile.my,7)
        ...
        show_message("No eligible terminal tiles! We might have some problems...")
        }
