/// @description sHealRayStats()
/*this script sets the stats for the two-by-four weapon to the unit calling it.
*/
...
attackstrength = 3//the base strength of the weapon
damagescaleswith = 4//the stat the damage of the weapon scales with, 1 is strength, 2 is skill
...
weaponhealing = 1//if the unit's current weapon is healing or hurting.

weapontraveltime = 5//how long the projectile, if any, takes to travel across a single tile.

weaponstrikesound = soundSwing1
weaponwindupsound = soundWindupSwing1
