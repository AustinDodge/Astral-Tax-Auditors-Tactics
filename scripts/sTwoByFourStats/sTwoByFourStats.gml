...
damagescaleswith = 1//the stat the damage of the weapon scales with, 1 is strength, 2 is skill
...
weapontraveltime = 0//how long the projectile, if any, takes to travel across a single tile. 0 for instant.
