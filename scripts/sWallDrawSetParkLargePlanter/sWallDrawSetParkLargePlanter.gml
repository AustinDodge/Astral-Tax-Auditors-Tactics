...
maxgrounddist = 4//the maximum distance from the ground tile
...
bigwallchance = 5//the chance that a bigwall will be eligible
tilewallchance = 10//the chance that a tilewall will be eligible
        ...
        if ds_list_size(ylist) > 0{
            ...
            switch southorwest{
                case 0://south facing wall
                    ...
                    tile_add(parkbg1,bigwallw*7,bigwallh*3,bigwallw,tilewallh*4,dx,dy,vtile.depth+3)
                    ; break;
                case 1://west facing wall
                    ...
                    dy -= 3
                    //dy += irandom_range(-3,3)
                    tile_add(parkbg1,bigwallw*6,bigwallh*3,bigwallw,tilewallh*4,dx,dy,vtile.depth+3)
                    ; break;
                }
