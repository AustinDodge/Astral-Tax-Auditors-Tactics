...
*/
attackrange = 4//how far our the weapon can attack
...
weapontraveltime = 3//how long the projectile, if any, takes to travel across a single tile.

weaponstrikesound = soundPlasmaBlast1
