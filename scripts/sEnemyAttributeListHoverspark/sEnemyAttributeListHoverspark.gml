...
ds_list_replace(vlist,26,2)//26 strength
ds_list_replace(vlist,27,70)//27 skill
ds_list_replace(vlist,28,80)//28 accuracy
ds_list_replace(vlist,30,15)//30 maxhp
ds_list_replace(vlist,29,15)//29 hp
...
ds_list_replace(vlist,25,3)//25 uprange

ds_list_replace(vlist,35,5)//35 unittype, hoverspark
