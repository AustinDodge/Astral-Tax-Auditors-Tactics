...
ahit = -1//the special "hit" variable that will be used, -1 for no change
adam = -1//the special "dam" variable that will be used, -1 for no change
aknock = -1//the special "knock" variable that will be used, -1 for no change
acrit = -1//the special "crit" variable that will be used, -1 for no change

mycaller = 0//the object, usually a control object, that created this. Destroy it at the end.
shove = 0//if the special attack is a shove
