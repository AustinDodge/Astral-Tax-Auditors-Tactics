...
koturns = ds_list_find_value(myattributelist,71)



drawear = 1//not in the list, determined in sAuditorPickSprites

//end regular oAuditor init event code
//************NOW DOING SPECIAL KO UNIT STUFF
...
amikod = 1
if koturns = -1{//if KO turns hasn't been set
    koturns = 2
    }
...
mykocount = koturns//the number of turns on the KO counter

drawko = 1
kotime = 20
alarm[5] = kotime//the timer for if the unit should draw the counter
