...
attackstrength = 15//the how much damage the explosion will cause
...
unitisobject = 1
facing = irandom(3)
rollingknock = 1//if the unit will continuously be knocked unless stopped, barrel
knockaxis = 1//if the unit can only be knocked along a specific axis. 0 is all, 1 is n-s, 2 is e-w
switch facing{
